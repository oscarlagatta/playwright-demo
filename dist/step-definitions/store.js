...
(0, _cucumber.Then)(/^I retrieved the "([^"]*)" text and store it as "([^"]*)" in global variables$/, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log("I retrieved ".concat(elementKey, " text and store it as ").concat(variableKey, " in global variables"));
