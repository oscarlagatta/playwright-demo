  ...
  function ScenarioWorld(options) {
    ...
    * */
    ...
    _defineProperty(_assertThisInitialized(_this), "newBrowser", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var automationBrowsers, automationBrowser, browserType;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              // setup automation browsers as allowed browsers by Playwright
              automationBrowsers = ['chromium', 'firefox', 'webkit']; // set a new type of AutomationBrowser passing a number
...
}(_cucumber.World); // always at the bottom of the file
