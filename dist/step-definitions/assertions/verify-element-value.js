              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.next = 2;
                      return (0, _htmlBehaviour.getValue)(page, elementIdentifier);
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            elementIdentifier = (0, _webElementHelper.getElementLocator)(page, elementKey, globalConfig);
            _context8.next = 5;
            return (0, _waitForBehaviour.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
              var elementAttribute;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            elementIdentifier = (0, _webElementHelper.getElementLocator)(page, elementKey, globalConfig);
            _context10.next = 5;
            return (0, _waitForBehaviour.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            _context12.next = 6;
            return (0, _waitForBehaviour.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
              var elementText;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            elementIdentifier = (0, _webElementHelper.getElementLocator)(page, elementKey, globalConfig);
            _context14.next = 5;
            return (0, _waitForBehaviour.waitFor)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13() {
              var attributeText;
              return regeneratorRuntime.wrap(function _callee13$(_context13) {
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      _context13.next = 2;
                      return (0, _htmlBehaviour.getAttributeText)(page, elementIdentifier, attribute);
