    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            page = this.screen.page, globalConfig = this.globalConfig; //  console.log(`I click the ${elementKey} (?:button|link|icon|element)` );
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      _context.next = 6;
                      return (0, _htmlBehaviour.clickElement)(page, elementIdentifier);
